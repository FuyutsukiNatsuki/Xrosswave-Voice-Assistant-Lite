...
_STRINGS = {
    ...
    # report mode
    "report_mode": {"ja": "レポート", "en": "Report"},
    "report_title": {"ja": "分析レポート", "en": "Analysis Report"},
    "export_png": {"ja": "PNG出力", "en": "Export PNG"},
    "report_saved": {"ja": "レポートを保存しました", "en": "Report saved"},
    "rep_avg_pitch": {"ja": "平均ピッチ", "en": "Average pitch"},
    "rep_range": {"ja": "範囲", "en": "range"},
    "rep_quality": {"ja": "平均声質", "en": "Average voice quality"},
    "rep_tendency": {"ja": "声の傾向の割合", "en": "Voice tendency"},
    "rep_register": {"ja": "声区の割合", "en": "Register"},
    "rep_resonance": {"ja": "響きの割合", "en": "Resonance"},
    "rep_vowel_formants": {"ja": "母音別フォルマント (F1×F2)", "en": "Vowel formants (F1×F2)"},
    "rep_male_avg": {"ja": "男声平均", "en": "Male avg"},
    "rep_female_avg": {"ja": "女声平均", "en": "Female avg"},
    "rep_your_voice": {"ja": "あなたの声", "en": "Your voice"},
    "rep_no_data": {"ja": "データがありません", "en": "No data collected"},
    "rep_duration": {"ja": "解析時間", "en": "Duration"},
    # left panel headers
